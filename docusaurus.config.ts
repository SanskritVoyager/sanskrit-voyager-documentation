...
const config: Config = {
  ...
  url: 'https://sanskrit-voyager-documentation.vercel.app',
  ...
  organizationName: 'Sanskrit Voyager', // Usually your GitHub org/user name.
  projectName: 'Sanskrit Voyager', // Usually your repo name.
